...
export function ProfileHist() {
  ...
  useEffect(() => {
    ...
    const reservasCards = document.querySelectorAll(".reservas-hist-card");
  ...
  return (
    <>
      <div className="menus">
        ...
        <Nav />
        ''
        <div className="reservas-hist-wrapper">
          <div className="reservas-info-wrapper">
            <div className="reservas-filter">
              ...
              <div className="reservas-hist-card-wrapper">
                <div className="reservas-hist-card">
                  ...
                  <div className="reserva-infos">
                    ...
                    <div className="price-reembolso">
                      <p className="price">
                        R$50,00 <span>Por pessoa</span>
                      </p>
                      <p className="fazer-reserva">Reservar agora</p>
                    </div>
                  </div>
                </div>
